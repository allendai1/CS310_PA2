...
//        sources.add(this.sg.indexOf(source));
//        this.bfs = new BreadthFirstPaths(this.sg.graph(), sources);
...
//        DegreesOfSeparationBFS deg = new DegreesOfSeparationBFS(filename, delimiter, source);
//        System.out.println(deg.graphPath("Kidman, Nicole").toString());
...
//            System.out.println(deg.graphPath(tests[i]).pop());
        ...
        System.out.println(deg.graphPath(source));
